...
class KrxIndexApiClient:
            ...
            if resp.status_code == 200:
                try:
                    ...
                    if 'MBR_NO' in json_resp:
                        ...
                        logger.error(f"KRX login failed - no MBR_NO in response: {json_resp}")
                        return False
    ...
    def fetch_data(self, payload: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            data_res = session.post(KRX_DOWNLOAD_URL, data=download_params)
